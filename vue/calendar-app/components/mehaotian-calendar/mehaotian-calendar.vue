			...
			<view class="calendar-wrapper ">
				<view class="content">
					...
					<view v-if="lunar" class="day-detail">
						...
						<view>{{canlender.lunar.gzYear+'年'+canlender.lunar.gzMonth+"月"+canlender.lunar.gzDay+"日 ("+canlender.lunar.Animal+'年)'}} {{canlender.lunar.IMonthCn+canlender.lunar.IDayCn}} {{canlender.lunar.isTerm?canlender.lunar.Term:''}}</view>					
					</view>
							...
							<view class="calender-body-date-week">
								<block v-for="(day , index) in weeks" :key="index">
									...
									:class="{
										...
										'lunar':lunar}"
									 @tap='selectDays(week,index,canlender.month === day.month ,day.disable)'>
										{{day.date}}
